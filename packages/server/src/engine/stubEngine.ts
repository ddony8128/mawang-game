import type { EngineOutput, EngineTask, GameEngine } from "./types";
...
export class StubGameEngine implements GameEngine {
  ...
  private handleCardUse(
    ...
    const cardType: string | undefined = data?.cardType;
  ...
  private handleDiscard(
    ...
    const idSet = new Set<string>(ids.filter((v) => typeof v === "string"));
